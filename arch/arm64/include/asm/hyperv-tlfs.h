 ...
 * - On ARM, HV_SYN_REG_ indicates a VP register accessed via hypercall
 */
...
#define HV_SYN_REG_CRASH_P0		(HV_REGISTER_CRASH_P0)
#define HV_SYN_REG_CRASH_P1		(HV_REGISTER_CRASH_P1)
#define HV_SYN_REG_CRASH_P2		(HV_REGISTER_CRASH_P2)
#define HV_SYN_REG_CRASH_P3		(HV_REGISTER_CRASH_P3)
#define HV_SYN_REG_CRASH_P4		(HV_REGISTER_CRASH_P4)
#define HV_SYN_REG_CRASH_CTL		(HV_REGISTER_CRASH_CTL)
